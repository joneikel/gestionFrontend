export const planning = () => (
  <svg
    id="Layer_5"
    enable-background="new 0 0 64 64" height="64px" viewBox="0 0 64 64" width="64px"
  ...
  >
    <g>
      <g>
        <g>
          <path
            d="m42 54v4c0 2.21-1.79 4-4 4h-32c-2.21 0-4-1.79-4-4v-50c0-2.21 1.79-4 4-4h8v4h-7c-.55 0-1 .45-1 1v9 39c0 .55.45 1 1 1h30c.55 0 1-.45 1-1v-3z"
            fill="#ffeaa7"
          />
        </g>
        <g>
          <path
            d="m42 21.17v24.83h-4v-24c1.42 0 2.78-.3 4-.84z"
            fill="#ffeaa7"
          />
        </g>
        <g>
          <path
            d="m31.94 19.95c-2.4-1.83-3.94-4.71-3.94-7.95 0-.69.07-1.36.2-2.01-.07.01-.13.01-.2.01h-12c-1.1 0-2-.9-2-2h-7c-.55 0-1 .45-1 1v9 39c0 .55.45 1 1 1h30c.55 0 1-.45 1-1v-35c-2.28 0-4.38-.76-6.06-2.05z"
            fill="#f0d0b4"
          />
        </g>
        <g>
          <path
            d="m32 50v4l-7.06-2.65c-.57-.21-.94-.75-.94-1.35s.37-1.14.94-1.35l7.06-2.65z"
            fill="#aab2bd"
          />
        </g>
        <g>
          <path
            d="m60.83 47.17c.72.73 1.17 1.73 1.17 2.83 0 2.21-1.79 4-4 4h-4v-4-4h4c1.1 0 2.1.45 2.83 1.17z"
            fill="#aab2bd"
          />
        </g>
        <g>
        ...
        <g>
          <path
            d="m29.28 23.45c-2.02-1.54-4.54-2.45-7.28-2.45-6.63 0-12 5.37-12 12 0 2.19.58 4.24 1.61 6.01 2.07 3.58 5.95 5.99 10.39 5.99s8.32-2.41 10.39-5.99c1.03-1.77 1.61-3.82 1.61-6.01 0-3.9-1.85-7.36-4.72-9.55z"
            fill="#e6e9ed"
          />
        </g>
        <g>
        ...
        <g>
          <path
            d="m30 4v2c-.87 1.16-1.5 2.51-1.8 3.99-.07.01-.13.01-.2.01h-12c-1.1 0-2-.9-2-2v-4c0-1.1.9-2 2-2h12c1.1 0 2 .9 2 2z"
            fill="#b4dd7f"
          />
        </g>
        <g>
        ...
        <g>
          <path
            d="m48 12c0 3.15-1.46 5.97-3.75 7.81-.68.54-1.44 1-2.25 1.35-1.22.54-2.58.84-4 .84-2.28 0-4.38-.76-6.06-2.05-2.4-1.83-3.94-4.71-3.94-7.95 0-.69.07-1.36.2-2.01.3-1.48.93-2.83 1.8-3.99 1.83-2.43 4.73-4 8-4 5.52 0 10 4.48 10 10z"
            fill="#e6e9ed"
          />
        </g>
        <g>
        ...
        <g>
          <path
            d="m54 24c4.42 0 8 3.58 8 8s-3.58 8-8 8-8-3.58-8-8c0-2.53 1.17-4.78 3-6.25 1.37-1.09 3.11-1.75 5-1.75z"
            fill="#e6e9ed"
          />
        </g>
        <g>
          <path
            d="m57.11 30.55c.54.28.89.84.89 1.45s-.35 1.17-.89 1.45l-4.77 2.38c-.22.11-.47.17-.72.17-.9 0-1.62-.72-1.62-1.62v-4.76c0-.9.72-1.62 1.62-1.62.25 0 .5.06.72.17z"
            fill="#ff826e"
          />
        </g>
      </g>
