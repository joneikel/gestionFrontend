...
const MeasurementForm = React.lazy(() => import("../../pages/MeasurementPage/forms/MeasurementForm"));
const UserForm = React.lazy(() => import("../../pages/UserPage/forms/UserForm"));
    ...
    <Suspense fallback={<EcLoading />}>
      <Switch>
        ...
        <Route
          ...
          component={() => (
            <ProtectedComponent scope="users:read">
              <UserPage />
            </ProtectedComponent>
          )}
        />
        ...
        <Route
          ...
          path="/editar-usuario"
          component={() => (
            <ProtectedComponent scope="users:update">
              <UserForm />
            </ProtectedComponent>
          )}
        />
